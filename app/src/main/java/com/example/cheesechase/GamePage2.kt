...
@Composable
fun GamePage2(navController: NavController){
    ...
    LaunchedEffect(Unit) {
        while(!end){
            ...
            for(i in positions){
                if(reward !=1){
                    if((i+ IntOffset(-21,move)== IntOffset(jerryX,+1200)) && (i !in trapList) && (i !in powerList)){
                        if(!jump){
                    ...
                    }else if((i+ IntOffset(-21,move)== IntOffset(jerryX,+1200)) && (i in trapList) && (i !in powerList)){
                        if(!jump){
                            var p : Int
                            var q : Int
                            p=(1..2).random()
